...
Of the 39 Contributor Network submissions, 7 had benchmark results
available on both hard2 and hard3 as of the snapshot date;
Table~\ref{tab:crossdist} presents these 7 submissions.

\begin{table}[h]
\centering
\caption{Cross-distribution performance: hard2 vs.\ hard3
(GPT-OSS 120B, SAIR official benchmark). Contributor Network
data, April~17, 2026~\citep{sair2026leaderboard}.
...
against performance on complementary distributions. AN45c exhibits the
smallest cross-split accuracy gap (7.5pp) of any non-degenerate
submission, suggesting that distribution robustness and peak accuracy
