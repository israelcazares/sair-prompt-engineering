...
\begin{enumerate}
  ...
  \item \textbf{Ordering effect}: Evidence that trivial-magma-first
    ...
    $+7.5$ percentage points at full scale ($n=400$; 95\% Wilson CIs
    [75.0\%, 82.9\%] vs.\ [67.1\%, 75.9\%]) (local evaluation; see
    Section~\ref{sec:official} for official benchmark divergence).
